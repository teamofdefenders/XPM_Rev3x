...
#define Def					  ((uint32_t)0x0BF90000)

#define Quad_Word_Shift 16
//#define Full_Page FLASH_PAGE_SIZE
#define Bank_Shift ((uint32_t)0x080000)
#define Max_Page_Shift ((uint32_t)0x7E000)
...
#define LOG_BOOTLOAD "\1 DEVICE BOOT LOAD INTIALIZING\0"
#define LOG_FLASHING "\1 DEVICE FLASH INPROGRESS\0"
...
void Boot_Change(BANK_TYPE newBank);
void Reflash ( MEM_PTR *Data_Ptr, BANK_TYPE isBank1 );
void Image_Load(MEM_PTR *Mem);
void Upgrade_Firmware(MEM_PTR *Mem);
